...
function ShowTraining({ training }) {
  ...
  return (
    ...
    <div class="showTraining w-11/12 mx-auto my-5 shadow-md p-8">
      {deleted === false && (
        <div class="showTraining-container">
          {template === "normal" && (
            <div class="showTraining-container-normal flex justify-between">
              <div class="showTraining-left flex flex-col md:flex-row md:items-center items-start gap-2 md:gap-10 w-1/2">
                <h3>{sessionName}</h3>
                <p>
                  créé le :<span>{formatDate}</span>
                </p>
              </div>
            ...
            <div class="showTraining-container-edit flex flex-col gap-5">
              ...
              <div class="exercices-container flex flex-col gap-2">
                ...
                <div class="exercices flex flex-col gap-2">
                  {exercises &&
                    exercises.map((exercise, index) => (
                      <div class="flex gap-5" key={index}>
                        <input
                          class="border-b border-gray-300 focus:outline-none w-full"
                          type="text"
                          placeholder="Nom de l'exercice"
                        ...
                        />
                        <input
                          class="border-b border-gray-300 focus:outline-none w-24"
                          type="number"
                          placeholder="Répétitions"
                          value={exercise.repetitions}
                          onChange={(e) =>
                        ...
                        />
                        <button
                          class="w-36 border-2 border-gray-300 text-gray-500 rounded-full py-2 text-sm font-bold hover:bg-red-100"
              ...
              <button
                class="w-48 border-2 border-gray-300 text-gray-500 rounded-full py-2 text-sm font-bold hover:bg-gray-100"
                onClick={addExercise}
              >
                Ajouter un exercice
              </button>
